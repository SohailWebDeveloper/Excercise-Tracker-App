...
const AddWorkout = () => {
  ...
  const postingData = async (e) => {
    ...
    if(activity===""){
      setActivityErrors("activity is required")
    }
    if(duration===""){
      setDurationErrors("duration is required")
    }
    if(date===""){
    ...
    try {
      let result = await fetch(
        "http://localhost:5000/api/v1/addworkout/addactivity",
        {
          method: "POST",
                  ...
                  <div className="m-sm-4">
                    <form>
                      ...
                      <div className="text-center mt-3">
                        <button onClick={postingData} className="btn btn-lg btn-primary">
                          Add Activity
                        </button>
                      </div>
                    </form>
      ...
      {/* <div className="container">
        <div className="row content">
          <div className="col-md-6 mb-3">
            <img src="https://images.unsplash.com/photo-1577221084712-45b0445d2b00?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=398&q=80" />
          </div>
          <div className="col-md-6">
            ...
            <div class="relative mb-3" data-te-input-wrapper-init>
              <input
                type="text"
                class="peer block min-h-[auto] w-full rounded border-2  px-3 py-[0.32rem] leading-[1.6] outline-none transition-all duration-200 ease-linear focus:placeholder:opacity-100 peer-focus:text-primary data-[te-input-state-active]:placeholder:opacity-100 motion-reduce:transition-none dark:text-neutral-200 dark:placeholder:text-neutral-200 dark:peer-focus:text-primary [&:not([data-te-input-placeholder-active])]:placeholder:opacity-0"
